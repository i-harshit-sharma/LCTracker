            ...
            <TabsContent value="personal" className="mt-0 border-none p-0">
              {!username && !isLoadingPrefs ? (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Please connect your LeetCode account in the dashboard to
                    view your skyline.
                  </AlertDescription>
                </Alert>
              ) : isLoading ? (
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                      <Card>
                        ...
                        <CardContent className="text-sm text-muted-foreground">
                          Watch your personal growth over the last 365 days.
                          Each building's height represents your daily
                          dedication.
                        </CardContent>
                      </Card>
                      <Card>
                        ...
                        <CardContent className="text-sm text-muted-foreground">
                          The city is alive with breathing animations and
                          interactive controls. Explore your progress from any
                          angle.
                        </CardContent>
                      </Card>
                      <Card>
                        ...
                        <CardContent className="text-sm text-muted-foreground">
                          Brighter buildings indicate higher solve counts.
                          Maintain your streak to see your skyline glow.
                        </CardContent>
                      </Card>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                      <Card>
                        ...
                        <CardContent className="text-sm text-muted-foreground">
                          See the top performers of all time. Each skyscraper
                          represents a developer's total solves in the
                          community.
                        </CardContent>
                      </Card>
                      <Card>
                        ...
                        <CardContent className="text-sm text-muted-foreground">
                          Hover over any building to see the user's name,
                          avatar, and exact problem count for the period.
                        </CardContent>
                      </Card>
                      <Card>
                        <CardHeader>
                        ...
                        <CardContent className="text-sm text-muted-foreground">
                          Gold, Silver, and Bronze colors highlight the current
                          leaders. Can you make it to the top three?
                        </CardContent>
                      </Card>
                    </div>
                  </CardContent>
